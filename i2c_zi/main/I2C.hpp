...
public:
    ...
    esp_err_t writeBytes(uint8_t reg_addr, uint8_t *data, uint8_t device_address, uint32_t i2c_timeout_ms, int num_data);
    esp_err_t registerRead(uint8_t reg_addr, uint8_t *data, size_t len, uint8_t device_address, uint32_t i2c_timeout_ms);
    esp_err_t deviceRead(uint8_t *data, size_t len, uint8_t device_address, uint32_t i2c_timeout_ms);
